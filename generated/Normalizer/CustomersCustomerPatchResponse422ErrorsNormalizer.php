...
class CustomersCustomerPatchResponse422ErrorsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\CustomersCustomerPatchResponse422Errors';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\CustomersCustomerPatchResponse422Errors';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \MauticInc\MEGA\OpenAPI\Generated\Model\CustomersCustomerPatchResponse422Errors();
        ...
        if (\array_key_exists('contact_limit', $data) && $data['contact_limit'] !== null) {
            $values_5 = array();
            foreach ($data['contact_limit'] as $value_5) {
                $values_5[] = $value_5;
            }
            $object->setContactLimit($values_5);
        ...
        if (\array_key_exists('send_welcome_email', $data) && $data['send_welcome_email'] !== null) {
            $values_7 = array();
            foreach ($data['send_welcome_email'] as $value_7) {
                $values_7[] = $value_7;
            }
            $object->setSendWelcomeEmail($values_7);
        ...
        if (\array_key_exists('welcome_email_template', $data) && $data['welcome_email_template'] !== null) {
            $values_8 = array();
            foreach ($data['welcome_email_template'] as $value_8) {
                $values_8[] = $value_8;
            }
            $object->setWelcomeEmailTemplate($values_8);
        ...
        if (\array_key_exists('welcome_email_subject', $data) && $data['welcome_email_subject'] !== null) {
            $values_9 = array();
            foreach ($data['welcome_email_subject'] as $value_9) {
                $values_9[] = $value_9;
            }
            $object->setWelcomeEmailSubject($values_9);
        ...
        if (\array_key_exists('restricted_ips', $data) && $data['restricted_ips'] !== null) {
            $values_10 = array();
            foreach ($data['restricted_ips'] as $value_10) {
                $values_10[] = $value_10;
            }
            $object->setRestrictedIps($values_10);
        ...
        if (\array_key_exists('start_date', $data) && $data['start_date'] !== null) {
            $values_11 = array();
            foreach ($data['start_date'] as $value_11) {
                $values_11[] = $value_11;
            }
            $object->setStartDate($values_11);
        ...
        if (\array_key_exists('renewal_date', $data) && $data['renewal_date'] !== null) {
            $values_12 = array();
            foreach ($data['renewal_date'] as $value_12) {
                $values_12[] = $value_12;
            }
            $object->setRenewalDate($values_12);
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('contactLimit') && null !== $object->getContactLimit()) {
            $values_5 = array();
            foreach ($object->getContactLimit() as $value_5) {
                $values_5[] = $value_5;
            }
            $data['contact_limit'] = $values_5;
        }
        ...
        if ($object->isInitialized('sendWelcomeEmail') && null !== $object->getSendWelcomeEmail()) {
            $values_7 = array();
            foreach ($object->getSendWelcomeEmail() as $value_7) {
                $values_7[] = $value_7;
            }
            $data['send_welcome_email'] = $values_7;
        }
        if ($object->isInitialized('welcomeEmailTemplate') && null !== $object->getWelcomeEmailTemplate()) {
            $values_8 = array();
            foreach ($object->getWelcomeEmailTemplate() as $value_8) {
                $values_8[] = $value_8;
            }
            $data['welcome_email_template'] = $values_8;
        }
        if ($object->isInitialized('welcomeEmailSubject') && null !== $object->getWelcomeEmailSubject()) {
            $values_9 = array();
            foreach ($object->getWelcomeEmailSubject() as $value_9) {
                $values_9[] = $value_9;
            }
            $data['welcome_email_subject'] = $values_9;
        }
        if ($object->isInitialized('restrictedIps') && null !== $object->getRestrictedIps()) {
            $values_10 = array();
            foreach ($object->getRestrictedIps() as $value_10) {
                $values_10[] = $value_10;
            }
            $data['restricted_ips'] = $values_10;
        }
        if ($object->isInitialized('startDate') && null !== $object->getStartDate()) {
            $values_11 = array();
            foreach ($object->getStartDate() as $value_11) {
                $values_11[] = $value_11;
            }
            $data['start_date'] = $values_11;
        }
        if ($object->isInitialized('renewalDate') && null !== $object->getRenewalDate()) {
            $values_12 = array();
            foreach ($object->getRenewalDate() as $value_12) {
                $values_12[] = $value_12;
            }
            $data['renewal_date'] = $values_12;
        }
