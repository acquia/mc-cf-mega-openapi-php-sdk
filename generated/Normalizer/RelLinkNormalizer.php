...
class RelLinkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\RelLink';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\RelLink';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \MauticInc\MEGA\OpenAPI\Generated\Model\RelLink();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('rel', $data) && $data['rel'] !== null) {
            $object->setRel($data['rel']);
            unset($data['rel']);
        }
        elseif (\array_key_exists('rel', $data) && $data['rel'] === null) {
            $object->setRel(null);
        }
    ...
    {
        $data = array();
        if ($object->isInitialized('rel') && null !== $object->getRel()) {
