...
class UsersUuidPatchResponse422ErrorsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\UsersUuidPatchResponse422Errors';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\UsersUuidPatchResponse422Errors';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \MauticInc\MEGA\OpenAPI\Generated\Model\UsersUuidPatchResponse422Errors();
        ...
        if (\array_key_exists('super', $data) && $data['super'] !== null) {
            $values_3 = array();
            foreach ($data['super'] as $value_3) {
                $values_3[] = $value_3;
            }
            $object->setSuper($values_3);
            unset($data['super']);
        }
        ...
        if (\array_key_exists('notify_limit_violation', $data) && $data['notify_limit_violation'] !== null) {
            $values_4 = array();
            foreach ($data['notify_limit_violation'] as $value_4) {
                $values_4[] = $value_4;
            }
            $object->setNotifyLimitViolation($values_4);
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('super') && null !== $object->getSuper()) {
            $values_3 = array();
            foreach ($object->getSuper() as $value_3) {
                $values_3[] = $value_3;
            }
            $data['super'] = $values_3;
        }
        if ($object->isInitialized('notifyLimitViolation') && null !== $object->getNotifyLimitViolation()) {
            $values_4 = array();
            foreach ($object->getNotifyLimitViolation() as $value_4) {
                $values_4[] = $value_4;
            }
            $data['notify_limit_violation'] = $values_4;
        }
