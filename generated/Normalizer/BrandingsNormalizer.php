...
class BrandingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\Brandings';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\Brandings';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \MauticInc\MEGA\OpenAPI\Generated\Model\Brandings();
        ...
        if (\array_key_exists('background_color', $data) && $data['background_color'] !== null) {
            $object->setBackgroundColor($data['background_color']);
            unset($data['background_color']);
        }
        elseif (\array_key_exists('background_color', $data) && $data['background_color'] === null) {
