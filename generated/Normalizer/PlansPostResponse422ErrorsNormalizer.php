...
class PlansPostResponse422ErrorsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\PlansPostResponse422Errors';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\PlansPostResponse422Errors';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \MauticInc\MEGA\OpenAPI\Generated\Model\PlansPostResponse422Errors();
        ...
        if (\array_key_exists('contact_limit', $data) && $data['contact_limit'] !== null) {
            $values_7 = array();
            foreach ($data['contact_limit'] as $value_7) {
                $values_7[] = $value_7;
            }
            $object->setContactLimit($values_7);
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('contactLimit') && null !== $object->getContactLimit()) {
            $values_7 = array();
            foreach ($object->getContactLimit() as $value_7) {
                $values_7[] = $value_7;
            }
            $data['contact_limit'] = $values_7;
        }
