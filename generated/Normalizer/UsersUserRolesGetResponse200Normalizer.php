...
class UsersUserRolesGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\UsersUserRolesGetResponse200';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\UsersUserRolesGetResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \MauticInc\MEGA\OpenAPI\Generated\Model\UsersUserRolesGetResponse200();
        ...
        if (\array_key_exists('data', $data) && $data['data'] !== null) {
            ...
            foreach ($data['data'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'MauticInc\\MEGA\\OpenAPI\\Generated\\Model\\Role', 'json', $context);
            }
