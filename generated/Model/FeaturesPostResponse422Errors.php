...
class FeaturesPostResponse422Errors extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * @return string[]|null
     */
    public function getIsMauticFeatureFlag() : ?array
    {
     ...
     * 
     *
     * @param string[]|null $isMauticFeatureFlag
     *
     * @return self
     */
    public function setIsMauticFeatureFlag(?array $isMauticFeatureFlag) : self
    {
